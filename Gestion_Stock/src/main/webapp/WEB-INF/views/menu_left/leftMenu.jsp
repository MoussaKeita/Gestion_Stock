                ...
                <div class="sidebar-nav navbar-collapse">
                  ...
                  <c:url value="/home/" var="home" />
                     ...
                     <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-users"></i> <fmt:message key="common.client"/><span class="fa arrow"></span></a>
                 ...
                 <c:url value="/client/" var="client" />
                  ...
                  <c:url value="/commandeClient/" var="cmdClient" />
                            ...
                            <!-- /.nav-second-level -->
                                                ...
                                                <li>
                            <a href="#"><i class="fa fa-users"></i> <fmt:message key="common.fournisseur"/><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                   ...
                   <c:url value="/stock/" var="stock" />
                        <li>
                           <a href="${stock}"><i class="fa fa-dropbox"></i>&nbsp;<fmt:message key="common.stock"/></a>               
                        </li>
                    <c:url value="/vente/" var="vente" />
                        <li>
                           <a href="${vente}"><i class="fa fa-edit fa-shopping-cart"></i>&nbsp;<fmt:message key="common.vente"/></a>
                        </li>
                        <li>
