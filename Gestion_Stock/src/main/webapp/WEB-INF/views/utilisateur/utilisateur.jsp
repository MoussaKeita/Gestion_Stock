    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.user" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->                 
                </div>
                                        ...
                                        <tr class="odd gradeX">                    
                                            ...
                                            <td>  
                                                  ...
                                                  <a href="${urlModif }"><i class="fa fa-edit">&nbsp;<fmt:message code="common.modifier"/></i></a>
                                                        &nbsp;|&nbsp;
                                                 <a href="javascript:void(0);" data-toggle="modal" data-target="#modalClient${user.getIdUtilisateur() }"><i class="fa fa-trash-o">&nbsp;<fmt:message code="common.supprimer"/></i></a>  
                                 <div class="modal fade" id="modalClient${user.getIdUtilisateur() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							                                <div class="modal-dialog">
							                                    <div class="modal-content">
							                                        ...
							                                        <div class="modal-body">
							                                          <fmt:message code="user.confirm.suppression"/>
							                                        </div>
							                                        <div class="modal-footer">
							                                            <button type="button" class="btn btn-default" data-dismiss="modal"><fmt:message code="common.annuler"/></button>
							                                            <c:url value="/utilisateur/supprimer/${user.getIdUtilisateur() }" var="urlSuppression"/>
