    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.category" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->                 
                </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message code="category.List" />
                        </div>
                        <!-- /.panel-heading -->
                                        ...
                                        <tr class="odd gradeX">                                       
                                            ...
                                            <td>  
                                                  ...
                                                  <a href="${urlModif }"><i class="fa fa-edit">&nbsp;<fmt:message code="common.modifier"/></i></a>
                                                        &nbsp;|&nbsp;
                                                 <a href="javascript:void(0);" data-toggle="modal" data-target="#modalCategory${category.getId() }"><i class="fa fa-trash-o">&nbsp;<fmt:message code="common.supprimer"/></i></a>  
                                 <div class="modal fade" id="modalCategory${category.getId() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							                                <div class="modal-dialog">
							                                    <div class="modal-content">
							                                        ...
							                                        <div class="modal-body">
							                                          <fmt:message code="category.confirm.suppression"/>
							                                        </div>
							                                        <div class="modal-footer">
							                                            <button type="button" class="btn btn-default" data-dismiss="modal"><fmt:message code="common.annuler"/></button>
							                                            <c:url value="/category/supprimer/${category.getId() }" var="urlSuppression"/>
