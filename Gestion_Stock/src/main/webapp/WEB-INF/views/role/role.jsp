    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="role.List" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->                 
                </div>
                ...
                <div class="row">
                     <div class="col-lg-12">
						  <ol class="breadcrumb">
						    <li><a href="<c:url value="/role/nouveau" />" ><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter"/></i></a></li>
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th><fmt:message code="common.NomRole"/></th>
                                            <th><fmt:message code="common.user"/></th> 
                                    ...
                                    <c:forEach items="${roles }" var="role">
                                        <tr class="odd gradeX">
                                            ...
                                            <td>${role.getUtilisateur().getNom() }</td>
                                           <td> 
                                                   <c:url value="/role/modifier/${role.getIdRole() }" var="urlModif" />                                      
                                                  <a href="${urlModif }"><i class="fa fa-edit">&nbsp;<fmt:message code="common.modifier"/></i></a>
                                                        &nbsp;|&nbsp;
                                                 <a href="javascript:void(0);" data-toggle="modal" data-target="#modalArticle${role.getIdRole() }"><i class="fa fa-trash-o">&nbsp;<fmt:message code="common.supprimer"/></i></a>  
                                 <div class="modal fade" id="modalArticle${role.getIdRole()  }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							                                <div class="modal-dialog">
							                                    <div class="modal-content">
							                                        ...
							                                        <div class="modal-footer">
							                                            ...
							                                            <c:url value="/role/supprimer/${role.getIdRole()  }" var="urlSuppression"/>
